    ...
    var a, t = function(e, i) {
        ...
        0 !== b.container.length)) {
            ...
            b.updateClasses = function() {
                ...
                b.paginationContainer && b.paginationContainer.length > 0) {
                    ...
                    "progress" === b.params.paginationType) {
                        ...
                        b.isHorizontal() || (l = n,
                        o = 1),
                        b.paginationContainer.find("." + b.params.paginationProgressbarClass).transform("translate(0,0) scaleX(" + o + ") scaleY(" + l + ")").transition(b.params.speed)
                    }
            ...
            b.setWrapperTranslate = function(e, a, t) {
                ...
                i = s(i)),
                b.params.virtualTranslate || (b.support.transforms3d ? b.wrapper.transform("translate(" + r + "px, " + i + "px)") : b.wrapper.transform("translate(" + r + "px, " + i + "px)")),
                ...
                flip: {
                    setTranslate: function() {
                        for (var e = 0; e < b.slides.length; e++) {
                            ...
                            t.transform("translate(" + l + "px, " + p + "px) rotateX(" + o + "deg) rotateY(" + n + "deg)")
                        }
                    },
                    setTransition: function(e) {
                ...
                cube: {
                    setTranslate: function() {
                        ...
                        for (var r = 0; r < b.slides.length; r++) {
                            ...
                            b.isHorizontal() || (p = l,
                            l = 0);
                            var u = "rotateX(" + (b.isHorizontal() ? 0 : -s) + "deg) rotateY(" + (b.isHorizontal() ? s : 0) + "deg) translate(" + l + "px, " + p + "px)";
                        ...
                        b.params.cube.shadow)
                            if (b.isHorizontal())
                                e.transform("translate(0px, " + (b.width / 2 + b.params.cube.shadowOffset) + "px) rotateX(90deg) rotateZ(0deg) scale(" + b.params.cube.shadowScale + ")");
                            else {
                                ...
                                e.transform("scale3d(" + g + ", 1, " + v + ") translate(0px, " + (b.height / 2 + w) + "px) rotateX(-90deg)")
                            }
                ...
                coverflow: {
                    setTranslate: function() {
                        for (var e = b.translate, t = b.isHorizontal() ? -e + b.width / 2 : -e + b.height / 2, r = b.isHorizontal() ? b.params.coverflow.rotate : -b.params.coverflow.rotate, i = b.params.coverflow.depth, s = 0, n = b.slides.length; n > s; s++) {
                            ...
                            Math.abs(u) < .001 && (u = 0),
                            Math.abs(c) < .001 && (c = 0);
                            var g = "translate(" + f + "px," + h + "px)  rotateX(" + c + "deg) rotateY(" + u + "deg)";
                            if (o.transform(g),
            ...
            b.scrollbar = {
                ...
                setTranslate: function() {
                    if (b.params.scrollbar) {
                        ...
                        b.isHorizontal() ? (b.support.transforms3d ? a.drag.transform("translate(" + e + "px, 0)") : a.drag.transform("translateX(" + e + "px)"),
                        a.drag[0].style.width = t + "px") : (b.support.transforms3d ? a.drag.transform("translate(0px, " + e + "px)") : a.drag.transform("translateY(" + e + "px)"),
