    ...
    a.fn.circliful = function(b, d) {
        ...
        return this.each(function() {
            ...
            var i = a("<canvas></canvas>").attr({
                width: f.dimension*3,
                height: f.dimension*3
            }).css({width:f.dimension,height:f.dimension}).appendTo(a(this)).get(0);
